...
const studentWorks = [
  {
    ...
    coverEmoji: "🌳",
    coverImage:
      "https://images.unsplash.com/photo-1771998872950-4bf206f43513?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmb3Jlc3QlMjBtYWdpY2FsJTIwZmFpcnklMjB0YWxlJTIwY2hpbGRyZW4lMjBib29rfGVufDF8fHx8MTc3Mjk0MzQ2OHww&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    ...
    coverEmoji: "🚀",
    coverImage:
      "https://images.unsplash.com/photo-1669028991857-d53d63e7eaf1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzcGFjZSUyMHJvY2tldCUyMGFkdmVudHVyZSUyMGdhbWUlMjBjb2xvcmZ1bHxlbnwxfHx8fDE3NzI5NDM0Njh8MA&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    ...
    coverEmoji: "⏰",
    coverImage:
      "https://images.unsplash.com/photo-1636718008440-e768b548b3ab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0aW1lJTIwdHJhdmVsJTIwY2xvY2slMjBmYW50YXN5JTIwYWR2ZW50dXJlfGVufDF8fHx8MTc3Mjk0MzQ2OXww&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    ...
    coverEmoji: "🐧",
    coverImage:
      "https://images.unsplash.com/photo-1718593381230-7f2dc037f236?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjdXRlJTIwcGVuZ3VpbiUyMHNub3clMjBhZHZlbnR1cmV8ZW58MXx8fHwxNzcyOTQzNDY5fDA&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    ...
    coverEmoji: "🌸",
    coverImage:
      "https://images.unsplash.com/photo-1673073529863-9d210d7c10c1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtYWdpYyUyMGdhcmRlbiUyMGZsb3dlcnMlMjBmYW50YXN5JTIwY29sb3JmdWx8ZW58MXx8fHwxNzcyOTQzNDY5fDA&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    ...
    coverEmoji: "🔢",
    coverImage:
      "https://images.unsplash.com/photo-1624117987059-f1b8c83edfaa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtYXRoJTIwbnVtYmVycyUyMHB1enpsZSUyMGdhbWUlMjBraWRzfGVufDF8fHx8MTc3Mjk0MzQ3MHww&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    ...
    coverEmoji: "🐠",
    coverImage:
      "https://images.unsplash.com/photo-1759222859619-8db751c63d62?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx1bmRlcndhdGVyJTIwb2NlYW4lMjBmaXNoJTIwa2luZ2RvbSUyMGNvbG9yZnVsfGVufDF8fHx8MTc3Mjk0MzQ3MHww&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    ...
    coverEmoji: "🏘️",
    coverImage:
      "https://images.unsplash.com/photo-1745296669988-d05031b620b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzbWFsbCUyMHRvd24lMjBzdHJlZXQlMjBjb3p5JTIwdmlsbGFnZXxlbnwxfHx8fDE3NzI5NDM0NzF8MA&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    ...
    coverEmoji: "🐱",
    coverImage:
      "https://images.unsplash.com/photo-1758228147088-840f9bfeeffd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjYXQlMjBtb3JuaW5nJTIwc3VubGlnaHQlMjBjb3p5JTIwcGhvdG9ncmFwaHl8ZW58MXx8fHwxNzcyOTQzNDc4fDA&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    ...
    coverEmoji: "🏙️",
    coverImage:
      "https://images.unsplash.com/photo-1756481602921-863b17ce6f83?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjaXR5JTIwYXJjaGl0ZWN0dXJlJTIwZ2VvbWV0cnklMjB1cmJhbiUyMGFic3RyYWN0fGVufDF8fHx8MTc3Mjk0MzQ3OHww&ixlib=rb-4.1.0&q=80&w=1080",
...
export function CreativePage({
  ...
  const categories = [
    ...
    {
      id: "novel" as Category,
      label: "小說",
      icon: "📖",
      count: studentWorks.filter((w) => w.category === "novel")
        .length,
    },
    {
      ...
      label: "圖片",
      icon: "🖼️",
      count: studentWorks.filter((w) => w.category === "image")
        .length,
    },
    {
      id: "picture-book" as Category,
      label: "繪本",
      icon: "📚",
      count: studentWorks.filter(
        (w) => w.category === "picture-book",
      ).length,
    },
    {
      id: "movie" as Category,
      label: "電影",
      icon: "🎬",
      count: studentWorks.filter((w) => w.category === "movie")
        .length,
    },
    {
      id: "game" as Category,
      label: "遊戲",
      icon: "🎮",
      count: studentWorks.filter((w) => w.category === "game")
        .length,
    },
  ];
      ...
      <section className="page-fade-in h-full flex flex-col px-8 py-6 relative overflow-hidden">
                ...
                {cat.id === "all" ? (
                  ...
                  >
                    <g clipPath="url(#bookClip)">
                      <path
                        d="M403.181 107.331C352.375 80.5894 252.243 132.261 223.479 177.751C210.664 198.107 211.571 212.777 211.571 221.099V666.349L587.068 900L657.679 861.445V427.826L272.143 206.471C292.832 180.433 339.361 148.682 374.25 161.434L717.653 345.099L717.653 828.153L788.443 789.529V306.485L403.181 107.331Z"
                        fill="currentColor"
                      />
                    </g>
                    <defs>
                  ...
                  >
                    <path
                      d="M833.957 660.676L729.623 416.676C710.623 372.009 682.29 346.676 649.957 345.009C617.957 343.342 586.957 365.676 563.29 408.342L499.957 522.01C486.623 546.01 467.623 560.343 446.957 562.01C425.956 564.01 404.956 553.01 387.956 531.343L380.622 522.01C356.956 492.343 327.622 478.01 297.622 481.01C267.622 484.01 241.956 504.677 224.956 538.343L167.289 653.343C146.622 695.01 148.622 743.343 172.956 782.677C197.289 822.01 239.622 845.676 285.956 845.676H711.29C755.957 845.676 797.623 823.343 822.29 786.01C847.623 748.676 851.623 701.676 833.957 660.676Z"
                      fill="currentColor"
                    />
                    <path
                      d="M332.329 379.369C394.553 379.369 444.994 328.927 444.994 266.703C444.994 204.479 394.553 154.036 332.329 154.036C270.105 154.036 219.662 204.479 219.662 266.703C219.662 328.927 270.105 379.369 332.329 379.369Z"
                      fill="currentColor"
                    />
                  </svg>
                ) : cat.id === "picture-book" ? (
                  ...
                  >
                    <g clipPath="url(#movieClip)">
                      <path
                        ...
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M199.523 233.333H799.523C808.363 233.333 816.842 236.845 823.093 243.097C829.344 249.348 832.856 257.826 832.856 266.667V300H166.189V266.667C166.189 257.826 169.701 249.348 175.953 243.097C182.204 236.845 190.682 233.333 199.523 233.333Z"
                        fill="currentColor"
                      />
                      <path
                        opacity="0.3"
                    ...
                    <defs>
                      <clipPath id="movieClip">
                        <rect
                          ...
                          height="800"
                          fill="white"
                          transform="translate(99.5234 100)"
                        />
                      </clipPath>
                    </defs>
                  </svg>
        ...
        <div className="mascot-bounce absolute bottom-6 right-8 z-[5]">
          <img
            ...
            style={{
              filter:
                "drop-shadow(0 8px 20px rgba(72,168,139,0.35))",
            }}
          />
        </div>
      </section>
      ...
      {selectedWork && (
        ...
        >
          <div
            ...
            style={{
              animation:
                "cardPop 0.3s cubic-bezier(0.34,1.56,0.64,1) both",
            }}
          >
            {/* Cover */}
            <div
            ...
            <div className="p-8">
              ...
              <div className="flex gap-4 mb-6">
                <div className="flex-1 bg-gradient-to-br from-[#FFE0E0] to-[#FFB8B8] rounded-[16px] px-4 py-3 flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-[11px] text-[#7A8BA0] font-bold">
                      喜歡數
                    </div>
                    <div className="text-[18px] font-black text-[#FF6B6B]">
                      {selectedWork.likes}
                    </div>
                  </div>
                </div>
                <div className="flex-1 bg-gradient-to-br from-[#E0E8FF] to-[#B8CAFF] rounded-[16px] px-4 py-3 flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-[18px] font-black text-[#5B7FDB]">
                      {selectedWork.views}
                    </div>
                  </div>
                </div>
